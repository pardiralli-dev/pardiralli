...
public class NordeaRequestModel extends RequestModel {
    ...
    private String VK_RETURN = String.format("https://urgas.ee/pardiralli/banklink/%s/success", Bank.nordea);
    private String VK_CANCEL = String.format("https://urgas.ee/pardiralli/banklink/%s/fail", Bank.nordea);

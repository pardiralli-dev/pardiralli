...
public class SEBRequestModel extends RequestModel {
    ...
    private String VK_RETURN = String.format("http://urgas.ee/pardiralli/banklink/%s/success", Bank.seb);
    private String VK_CANCEL = String.format("http://urgas.ee/pardiralli/banklink/%s/fail", Bank.seb);

...
@Data
public class SwedbankRequestModel {
    ...
    private final String VK_CANCEL = "https://pardiralli.herokuapp.com/banklink/swedbank/fail";
    private final String VK_DATETIME = BanklinkUtils.currentDatetime();
    private final String VK_MAC = BanklinkUtils.getMAC("swedbank-private.der",

...
public class LHVRequestModel extends RequestModel {
    ...
    private String VK_RETURN = String.format("http://urgas.ee/pardiralli/banklink/%s/success", Bank.lhv);
    private String VK_CANCEL = String.format("http://urgas.ee/pardiralli/banklink/%s/fail", Bank.lhv);
